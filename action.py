...
def Action(send) :   
    ...
    if "what is your name" in   data_btn :
      speak.speak("my name is johnny sins")  
      return "my name is johnny sins"
    ...
    elif 'what is todays weather' in data_btn :
       ans   = weather.Weather()
       speak.speak(ans) 
       return ans
        ...
        speak.speak( "anshit, i cant recognize you voice, please repeat again!")
        return "anshit i cant recognize you voice, please repeat again!"       
